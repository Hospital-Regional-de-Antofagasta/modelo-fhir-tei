...
INSERT INTO [dbo].[ListaEspera_TAB_Establecimiento]
     ...
     VALUES
		...
		,((SELECT TOP (1) [Id] FROM [dbo].[TAB_DEIS_Comuna] WHERE [CodigoFHIR] = '02101'),(SELECT TOP (1) [Id] FROM [dbo].[ListaEspera_TAB_JerarquiaSalud] WHERE [Codigo] = '3' AND [IdTipoJerarquiaSalud] = 1),'Hospital','103100','Hospital Dr. Leonardo Guzmán (Antofagasta)','Avenida','Azapa','5935')
