IF OBJECT_ID(N'dbo.DomicilioPaciente', N'U') IS NULL BEGIN
  ...
  (
    ...
    CodigoUso VARCHAR(10) NOT NULL CONSTRAINT FK_DOMICILIO_USO FOREIGN KEY REFERENCES [dbo].[TAB_FHIR_UsoDomicilioPersona](Codigo),
    ...
    [CreatedBy] [VARCHAR](10) NOT NULL CONSTRAINT FK_DOMICILIO_USUARIO FOREIGN KEY REFERENCES [dbo].[Segu_Usuarios]([Segu_Usr_Cuenta]),
