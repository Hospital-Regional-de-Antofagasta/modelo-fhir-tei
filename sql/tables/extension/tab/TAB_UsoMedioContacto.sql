...
IF OBJECT_ID(N'dbo.TAB_UsoMedioContacto', N'U') IS NULL BEGIN  
  CREATE TABLE [dbo].[TAB_UsoMedioContacto] (
  ...
  INSERT INTO [dbo].[TAB_UsoMedioContacto] ([Codigo], [Texto]) VALUES
    ('home', 'Casa'),
    ('work', 'Trabajo'),
    ('temp', 'Temporal'),
    ('old', 'Antiguo'),
