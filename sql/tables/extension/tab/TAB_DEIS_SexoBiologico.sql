...
CREATE TABLE [dbo].[TAB_DEIS_SexoBiologico](
    [Id] [TINYINT] CONSTRAINT PK_DEIS_SEXOBIOLOGICO PRIMARY KEY,
    [Codigo] [VARCHAR](10) NOT NULL UNIQUE,
    [Texto] [VARCHAR](15) NOT NULL,
    [Descripcion] [VARCHAR](200) NOT NULL,
    [Vigencia] BIT NOT NULL DEFAULT 1,
    [CreatedBy] [VARCHAR](10) CONSTRAINT FK_DEIS_SEXOBIOLOGICO_USUARIO FOREIGN KEY REFERENCES [dbo].[Segu_Usuarios]([Segu_Usr_Cuenta]) NOT NULL DEFAULT SUSER_NAME(),
