...
IF OBJECT_ID(N'dbo.IdentificadorPaciente', N'U') IS NULL BEGIN
  ...
  (
    ...
    CodigoTipo CHAR(2) NOT NULL CONSTRAINT FK_IDENTIFICADORPACIENTE_TIPO FOREIGN KEY REFERENCES TAB_TipoIdentificadorPersona(Codigo),
    CodigoUso CHAR(2) NOT NULL CONSTRAINT FK_IDENTIFICADORPACIENTE_USO FOREIGN KEY REFERENCES TAB_UsoIdentificadorPersona(Codigo),
