...
ALTER TABLE [dbo].[TAB_DEIS_EspecialidadMedica]
ADD
    CONSTRAINT FK_DEIS_ESPECIALIDADMEDICA_USUARIO FOREIGN KEY (CreatedBy) REFERENCES [dbo].[Segu_Usuarios]([Segu_Usr_Cuenta]);

ALTER TABLE [dbo].[EspecialidadMedicaPrestador]
ADD
...
ALTER TABLE [dbo].[SolicitudInterconsulta]
ADD
    CONSTRAINT FK_SOLICITUDINTERCONSULTA_PACIENTE FOREIGN KEY (NumeroPaciente) REFERENCES [dbo].[PAC_Paciente](PAC_PAC_Numero),
    CONSTRAINT FK_SOLICITUDINTERCONSULTA_ESPECIALIDAD FOREIGN KEY (IdEspecialidadDestino) REFERENCES [dbo].[TAB_DEIS_EspecialidadMedica](Id),
    CONSTRAINT FK_SOLICITUDINTERCONSULTA_SUBESPECIALIDAD FOREIGN KEY (IdSubEspecialidadDestino) REFERENCES [dbo].[TAB_DEIS_EspecialidadMedica](Id),
    CONSTRAINT FK_SOLICITUDINTERCONSULTA_MOTIVOCIERREINTERCONSULTA FOREIGN KEY (IdMotivoCierreInterconsulta) REFERENCES [dbo].[TAB_FHIR_MotivoCierreInterconsulta](Id);

ALTER TABLE [dbo].[FHIR_BundleIniciarEnriquecido]
ADD
    CONSTRAINT FK_FHIR_BUNDLEINICIARENRIQUECIDO_SOLICITUDINTERCONSULTA FOREIGN KEY (IdSolicitudInterconsulta) REFERENCES [dbo].[SolicitudInterconsulta](Id);

ALTER TABLE [dbo].[TAB_FHIR_MotivoCierreInterconsulta]
ADD
    -- -- CONSTRAINT PK_FHIR_MOTIVOCIERREINTERCONSULTA PRIMARY KEY (Id),
